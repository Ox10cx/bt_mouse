...
//    public static final UUID LOSS_FUNC_UUID = UUID.fromString("00002a06-0000-1000-8000-00805f9b34fb");
    ...
    public boolean getMouseRsp() {
        ...
        if (mBluetoothGatt != null && mBluetoothGatt.getService(MOUSE_SERVICE_UUID) != null) {
            characteristic = mBluetoothGatt.getService(MOUSE_SERVICE_UUID).getCharacteristic(MOUSE_WRITE_FUNC_UUID);
        }
...
//            if (characteristic == null) {
//                Lg.i(TAG, "not support the immediate alert funcion?");
//                return false;
//            }
//
//            if (characteristic != null) {
//                characteristic.setValue(new byte[]{(byte) val});
//                Lg.i(TAG, "writeCharacteristic:" + val);
//                //往蓝牙模块写入数据
//                writeCharacteristic(characteristic);
//            }
//        } else {
//            Lg.i(TAG, "characteristic= null");
//            Lg.i(TAG, "not support the immediate alert service?");
//            return false;
//        }
//
//        return true;
